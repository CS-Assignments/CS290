 ...
 * </article>
 */
function insertNewTwit(twitTextValue, twitAuthorValue) {

  var twitContext = {
    text: twitTextValue,
    author: twitAuthorValue
  };
  
  var twitHTML = Handlebars.templates.twitCard(twitContext);
  var twitContainer = document.getElementById("container");
